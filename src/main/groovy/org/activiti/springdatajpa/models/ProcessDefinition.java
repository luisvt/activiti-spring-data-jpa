...
public class ProcessDefinition implements java.io.Serializable {
    ...
    private Set<Execution> executions = new HashSet<>(0);
    private Set<ProcessDefinitionInfo> processDefinitionInfos = new HashSet<>(0);
    private Set<Task> tasks = new HashSet<>(0);
    private Set<IdentityLink> identityLinks = new HashSet<>(0);
